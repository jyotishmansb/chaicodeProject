        ...
        <section className='section-cohorts'>
            <div className="cohorts-section-container">
                ...
                <div className="cohorts-wrapper">
                    {
                        cohorts.map(({ id, youtubeUrl, title, desc, date, duration, price, oldPrice }) => {
                            return <CohortsCard key={id}
                                title={title} youtubeUrl={youtubeUrl} desc={desc} date={date} duration={duration} price={price} oldPrice={oldPrice} />
                        })
